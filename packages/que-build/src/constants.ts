...
export const NAME = 'que'
export const U_NAME = NAME.toUpperCase()
...
export const CLIENT_PUBLIC_PATH = `/@${NAME}/client`
export const ENV_PUBLIC_PATH = `/@${NAME}/env`
...
export const CLIENT_ENTRY = resolve(PACKAGE_DIR, 'dist/client/client.mjs')
export const ENV_ENTRY = resolve(PACKAGE_DIR, 'dist/client/env.mjs')
